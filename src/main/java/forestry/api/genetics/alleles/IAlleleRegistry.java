...
/**
 * Manages {@link IIndividualRootForestry}, {@link IAllele}s, {@link IFruitFamily}s, {@link IClassification}, the blacklist and allows creation of research notes.
 *
 * @author SirSengir
 */
public interface IAlleleRegistry {
	...
	/**
	 * Register a {@link IIndividualRootForestry}.
	 *
	 * @param root {@link IIndividualRootForestry} to register.
	 */
	void registerSpeciesRoot(IIndividualRootForestry root);

	/**
	 * @return Map of all registered {@link IIndividualRootForestry}.
	 */
	Map<String, IIndividualRootForestry> getSpeciesRoot();

	/**
	 * Retrieve the {@link IIndividualRootForestry} with the given uid.
	 *
	 * @param uid Unique id for the species class, i.e. "rootBees", "rootTrees", "rootButterflies".
	 * @return {@link IIndividualRootForestry} if it exists, null otherwise.
	 */
	@Nullable
	IIndividualRootForestry getSpeciesRoot(String uid);

	/**
	 * Retrieve a matching {@link IIndividualRootForestry} for the given itemstack.
	 *
	 * @param stack An itemstack possibly containing NBT data which can be converted by a species root.
	 * @return {@link IIndividualRootForestry} if found, null otherwise.
	 */
	@Nullable
	IIndividualRootForestry getSpeciesRoot(ItemStack stack);

	/**
	 * Retrieve a matching {@link IIndividualRootForestry} for the given {@link IIndividualForestry}-class.
	 *
	 * @param individualClass Class extending {@link IIndividualForestry}.
	 * @return {@link IIndividualRootForestry} if found, null otherwise.
	 */
	@Nullable
	IIndividualRootForestry getSpeciesRoot(Class<? extends IIndividualForestry> individualClass);

	/**
	 * Retrieve a matching {@link IIndividualRootForestry} for the given {@link IIndividualForestry}
	 */
	IIndividualRootForestry getSpeciesRoot(IIndividualForestry individual);
	 ...
	 */
	@Nullable
	IIndividualForestry getIndividual(ItemStack stack);
	 ...
	 * @param species    {@link IAlleleSpeciesForestry} to encode on the research note.
	 * @return An itemstack containing a research note with the given species encoded onto it.
	 */
	ItemStack getSpeciesNoteStack(GameProfile researcher, IAlleleSpeciesForestry species);
