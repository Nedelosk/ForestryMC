...
public interface IFlowerRegistry {
	 ...
	 */
	boolean growFlower(String flowerType, World world, IIndividualForestry individual, BlockPos pos, Collection<IBlockState> potentialFlowers);
	 ...
	 * Calls the appropriate IFlowerGrowthRule to grow a flower at a specified position.
	 *
	 * @deprecated since Forestry 5.5.4. Use {@link #growFlower(String, World, IIndividualForestry, BlockPos, Collection)}
	 */
	@Deprecated
	boolean growFlower(String flowerType, World world, IIndividualForestry individual, BlockPos pos);
}
