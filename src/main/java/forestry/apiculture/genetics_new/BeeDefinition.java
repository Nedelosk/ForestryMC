...
import forestry.core.genetics_new.mutations.MutationCollector;
...
public enum BeeDefinition implements IBeeDefinition {
	...
	FOREST(BeeBranchDefinition.HONEY, "nigrocincta", true, new Color(0x19d0ec), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.FLOWERING, EnumAllele.Flowering.SLOWER);
			template.set(EnumBeeChromosome.FERTILITY, EnumAllele.Fertility.HIGH);
		}
	...
	CULTIVATED(BeeBranchDefinition.HONEY, "mellifera", true, new Color(0x5734ec), new Color(0xffdc16)) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.FAST);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.SHORTEST);
		}
	...
	NOBLE(BeeBranchDefinition.NOBLE, "nobilis", false, new Color(0xec9a19), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWER);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.SHORT);
			template.set(EnumBeeChromosome.FLOWERING, EnumAllele.Flowering.SLOW);
		}
	...
	MAJESTIC(BeeBranchDefinition.NOBLE, "regalis", true, new Color(0x7f0000), new Color(0xffdc16)) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.NORMAL);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.SHORTENED);
			template.set(EnumBeeChromosome.FERTILITY, EnumAllele.Fertility.MAXIMUM);
		}
	...
	IMPERIAL(BeeBranchDefinition.NOBLE, "imperatorius", false, new Color(0xa3e02f), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWER);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.NORMAL);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectBeatific);
		}
	...
	INDUSTRIOUS(BeeBranchDefinition.INDUSTRIOUS, "industria", false, new Color(0xffffff), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWER);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.NORMAL);
			template.set(EnumBeeChromosome.FLOWERING, EnumAllele.Flowering.FAST);
		}
	...
	STEADFAST(BeeBranchDefinition.HEROIC, "legio", false, new Color(0x4d2b15), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWER);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.NORMAL);
			template.set(EnumBeeChromosome.NEVER_SLEEPS, true);
			template.set(EnumBeeChromosome.CAVE_DWELLING, true);
		}
	...
	VALIANT(BeeBranchDefinition.HEROIC, "centurio", true, new Color(0x626bdd), new Color(0xffdc16)) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOW);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.LONG);
			template.set(EnumBeeChromosome.NEVER_SLEEPS, true);
			template.set(EnumBeeChromosome.CAVE_DWELLING, true);
		}
	...
	HEROIC(BeeBranchDefinition.HEROIC, "kraphti", false, new Color(0xb3d5e4), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			...
			template.set(EnumBeeChromosome.NEVER_SLEEPS, true);
			template.set(EnumBeeChromosome.CAVE_DWELLING, true);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectHeroic);
		}
	...
	SINISTER(BeeBranchDefinition.INFERNAL, "caecus", false, new Color(0xb3d5e4), new Color(0x9a2323)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWER);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.NORMAL);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectAggressive);
		}
	...
	DEMONIC(BeeBranchDefinition.INFERNAL, "draco", false, new Color(0xf4e400), new Color(0x9a2323)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWER);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.LONGER);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectIgnition);
		}
	...
	AUSTERE(BeeBranchDefinition.AUSTERE, "correpere", false, new Color(0xfffac2), new Color(0xffdc16)) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWEST);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.LONGER);
			template.set(EnumBeeChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.DOWN_2);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectCreeper);
		}
	...
	EDENIC(BeeBranchDefinition.TROPICAL, "humboldti", false, new Color(0x393d0d), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWEST);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.LONGER);
			template.set(EnumBeeChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.BOTH_2);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectExploration);
		}
	...
	SPECTRAL(BeeBranchDefinition.END, "idolum", true, new Color(0xa98bed), new Color(0xd9de9e)) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectReanimation);
		}
	...
	PHANTASMAL(BeeBranchDefinition.END, "lemur", false, new Color(0xcc00fa), new Color(0xd9de9e)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWEST);
			template.set(EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.LONGEST);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectResurrection);
		}
	...
	LEPORINE(BeeBranchDefinition.FESTIVE, "lepus", false, new Color(0xfeff8f), new Color(0x3cd757)) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectFestiveEaster);
		}
	...
	MERRY(BeeBranchDefinition.FESTIVE, "feliciter", false, new Color(0xffffff), new Color(0xd40000)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.NEVER_SLEEPS, true);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectSnowing);
		}
	...
	TIPSY(BeeBranchDefinition.FESTIVE, "ebrius", false, new Color(0xffffff), new Color(0xc219ec)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.NEVER_SLEEPS, true);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectDrunkard);
		}
	...
	TRICKY(BeeBranchDefinition.FESTIVE, "libita", false, new Color(0x49413B), new Color(0xFF6A00)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.NEVER_SLEEPS, true);
			template.set(EnumBeeChromosome.TOLERATES_RAIN, true);
			template.set(EnumBeeChromosome.FLOWER_PROVIDER, EnumAllele.Flowers.GOURD);
		}
	...
	FARMERLY(BeeBranchDefinition.AGRARIAN, "arator", true, new Color(0xD39728), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOW);
			template.set(EnumBeeChromosome.TERRITORY, EnumAllele.Territory.LARGE);
		}
	...
	AGRARIAN(BeeBranchDefinition.AGRARIAN, "arator", true, new Color(0xFFCA75), new Color(0xFFE047)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOW);
			template.set(EnumBeeChromosome.HUMIDITY_TOLERANCE, EnumAllele.Tolerance.BOTH_2);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectFertile);
			template.set(EnumBeeChromosome.TERRITORY, EnumAllele.Territory.LARGE);
		}
	...
	BOGGY(BeeBranchDefinition.BOGGY, "paluster", true, new Color(0x698948), new Color(0xffdc16)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.TOLERATES_RAIN, true);
			template.set(EnumBeeChromosome.NEVER_SLEEPS, true);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectMycophilic);
			template.set(EnumBeeChromosome.TERRITORY, EnumAllele.Territory.LARGER);
		}
	...
	SECLUDED(BeeBranchDefinition.MONASTIC, "contractus", true, new Color(0x7b6634), new Color(0xfff7b6)) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.FLOWERING, EnumAllele.Flowering.FASTEST);
		}
	...
	HERMITIC(BeeBranchDefinition.MONASTIC, "anachoreta", false, new Color(0xffd46c), new Color(0xfff7b6)) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumBeeChromosome.FLOWERING, EnumAllele.Flowering.FASTEST);
			template.set(EnumBeeChromosome.EFFECT, AlleleEffects.effectRepulsion);
		}
	...
	public <B extends IRootComponentBuilder> void onComponent(ComponentKey<?, B> key, B builder) {
		...
		if (key == ComponentKeys.TEMPLATES) {
			...
			templateBuilder.set(EnumBeeChromosome.SPECIES, species);
			...
			MutationCollector<BeeDefinition, IAlleleBeeSpecies, BeeMutation>
	...
	@Override
	public final ItemStack getMemberStack(IOrganismType beeType) {
