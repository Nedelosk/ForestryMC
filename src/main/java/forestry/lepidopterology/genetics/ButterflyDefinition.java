...
public enum ButterflyDefinition implements IButterflyDefinition {
	CabbageWhite(ButterflyBranchDefinition.Pieris, "cabbageWhite", "rapae", new Color(0xccffee), true, 1.0f) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SIZE, EnumAllele.Size.AVERAGE);
		}
	},
	...
	Aurora(ButterflyBranchDefinition.Anthocharis, "orangeTip", "cardamines", new Color(0xe34f05), true, 0.5f) {
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SIZE, EnumAllele.Size.SMALLER);
		}
	},
	Postillion(ButterflyBranchDefinition.Colias, "postillion", "croceus", new Color(0xd77e04), true, 0.5f) {
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SPEED, EnumAllele.Speed.SLOW);
		}
	},
	...
	SpringAzure(ButterflyBranchDefinition.Celastrina, "springAzure", "argiolus", new Color(0xb8cae2), true, 0.3f) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SIZE, EnumAllele.Size.SMALLER);
			template.set(EnumButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.SHORT);
		}
	},
	...
	CitrusSwallow(ButterflyBranchDefinition.Papilio, "swallowtailC", "demodocus", new Color(0xeae389), false, 1.0f) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SPEED, EnumAllele.Speed.SLOWER);
			template.set(EnumButterflyChromosome.SIZE, EnumAllele.Size.LARGE);
			template.set(EnumButterflyChromosome.FERTILITY, 10);
			template.set(EnumButterflyChromosome.METABOLISM, 8);
			template.set(EnumButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.SHORTER);
			template.set(EnumButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
			template.set(EnumButterflyChromosome.HUMIDITY_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
		}
	},
	EmeraldPeacock(ButterflyBranchDefinition.Papilio, "emeraldPeacock", "palinurus", new Color(0x7cfe80), true, 0.1f) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SIZE, EnumAllele.Size.LARGE);
			template.set(EnumButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.NORMAL);
			template.set(EnumButterflyChromosome.FERTILITY, 5);
			template.set(EnumButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
			template.set(EnumButterflyChromosome.HUMIDITY_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
		}
	},
	ThoasSwallow(ButterflyBranchDefinition.Papilio, "swallowtailT", "thoas", new Color(0xeac783), false, 0.2f) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SPEED, EnumAllele.Speed.SLOWER);
			template.set(EnumButterflyChromosome.SIZE, EnumAllele.Size.LARGE);
			template.set(EnumButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.SHORTEST);
		}
	},
	...
	SpeckledWood(ButterflyBranchDefinition.Pararge, "speckledWood", "aegeria", new Color(0x947245), true, 1.0f) {
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.FERTILITY, 2);
		}
	},
	...
	MBlueMorpho(ButterflyBranchDefinition.Morpho, "blueMorphoM", "menelaus", new Color(0x72e1fd), true, 0.5f) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SIZE, EnumAllele.Size.LARGER);
			template.set(EnumButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.SHORTEST);
			template.set(EnumButterflyChromosome.FERTILITY, 2);
		}
	},
	...
	BlueWing(ButterflyBranchDefinition.Myscelia, "blueWing", "ethusa", new Color(0x3a93cc), true, 0.3f) {
		...
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.SIZE, EnumAllele.Size.AVERAGE);
			template.set(EnumButterflyChromosome.METABOLISM, 5);
		}
	},
	...
	BlueDuke(ButterflyBranchDefinition.Bassarona, "blueDuke", "durga", new Color(0x304240), true, 0.5f) {
		...
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.BOTH_1);
		}
	},
	...
	LLacewing(ButterflyBranchDefinition.Cethosia, "leopardLacewing", "cyane", new Color(0xfb8a06), true, 0.7f) {
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
			template.set(EnumButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.UP_1);
			template.set(EnumButterflyChromosome.HUMIDITY_TOLERANCE, EnumAllele.Tolerance.UP_1);
		}
	},
